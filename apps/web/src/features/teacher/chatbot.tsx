...
/**
 * Teacher Ask Ed8AI chat (KAN-76). Mirrors the student chatbot UX but with
 * a faculty-oriented greeting. Cascades: authed REST → public Gemini.
 */
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      role: "assistant",
      text: "Hi! I'm Ed8AI. Ask me about your classes, students at risk, attendance summaries, IA progress, or upcoming submissions.",
    },
  ]);
      ...
      <div className="flex h-[calc(100vh-10rem)] flex-col">
        ...
        >
          <input
            ...
            placeholder="Ask about classes, students, attendance…"
            value={input}
